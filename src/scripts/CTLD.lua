...
ctld.crateWaitTime = 240 -- time in seconds to wait before you can spawn another crate
...
ctld.pickupZones = {
    { "FOP-LONDON", "blue", -1, "yes", 2 },
    { "PICKUP-BAB", "white", -1, "yes", 0 },
    { "PICKUP-GUD", "white", -1, "yes", 0 },
    { "PICKUP-SOCHI", "orange", -1, "yes", 1 },
    { "FOP-Otkrytka", "orange", -1, "yes", 1 },
    { "Warsaw","blue",-1,"yes",2},
	{ "PICKUP-1","blue",-1,"yes",2},
	{ "KOBZONE","blue",-1,"yes",2},
	{ "SENZONE","blue",-1,"yes",2},
	{ "KUTZONE","blue",-1,"yes",2},
	{ "Kaemka","orange",-1,"yes",1},
...
ctld.wpZones = {
    { "PICKUP-GUD", "none","yes", 0 },
    { "PICKUP-BAB", "none","yes", 0 },
}
...
ctld.transportPilotNames = {
    ...
    "USAA - UH1 - Sukhumi - Cold",
    "USAA - UH1 - Sukhumi - Cold #001",
    "USAA - UH1 - Sukhumi - Cold #002",
    "USAA - UH1 - Sukhumi - Cold #003",
    "USAA - UH1 - Sukhumi - Cold #004",
    "UA - MI8 - Sukhumi - Cold #001",
    "UA - MI8 - Sukhumi - Cold",
    "UA - MI8 - Gudauta - Cold",
    "RUS - MI8 GUD",
...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 801, desc = "M-2 Bradley", unit = "M-2 Bradley", side = 2, cratesRequired = 2 },
    ...
    ["SHRT AA Crates"] = {
        ...
        { weight = 406, desc = "ZSU-23-4 Shilka", unit = "ZSU-23-4 Shilka", side = 1, cratesRequired = 2 },
    ...
    ["LRNG AA Crates"] = {
		{ weight = 610, desc = "Patriot AMG", unit = "Patriot AMG", side = 2},
...
function ctld.spawnCrateGroup(_heli, _positions, _types)
    ...
    _dest = { x = _dest.x + 0.1, _y = _dest.y + 0.1, z = _dest.z + 0.1 }
...
function ctld.createSmokeMarker(_enemyUnit, _colour)
    ...
    trigger.action.smoke({ x = (_enemyPoint.x + math.random(-20,20)), y = _enemyPoint.y, z = (_enemyPoint.z + math.random(-22,20))}, _colour)
end
